...
class FoodsReviewProvider extends ChangeNotifier {
  ...
  FoodsReviewProvider(this.filterOrSort); //fetch 한 애들인지
  ...
  Future fetchNextFoods( ) async { //fetch 해오기 위함
    if (_isFetchingFoods) return; //fetch한 상품이라면 그냥 아무것도 없는 거를 return한다.
